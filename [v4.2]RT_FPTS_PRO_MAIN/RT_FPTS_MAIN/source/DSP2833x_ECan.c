...
void CanDataRecv(void)
{
	...
	if(ECanbRegs.CANRMP.bit.RMP30 == 1)     // 回复设置帧
	{
	    ...
	    {
	    	eCANSend(0x82100d00, CanTxPack1);
	    	eCANSend(0x82100d01, CanTxPack2);
	    }
	}
}
...
// 数据帧
    ...
    CanTxPack2.Data3 = (NO2UacIn  / 10) & 0xff;
    CanTxPack2.Data4 = ((NO2UacIn / 10) >> 8) & 0xff;
    CanTxPack2.Data5 = (Uint16)(((float)NO1Cur / 10 - 16.308 ) / 0.9616) &  0xff;
    CanTxPack2.Data6 = ((Uint16)(((float)NO1Cur / 10 - 16.308 ) / 0.9616 ) >> 8) & 0xff;
    CanTxPack2.Data7 = (Uint16)(((float)NO2Cur / 10 - 16.161 ) / 0.9599)  & 0xff;
    CanTxPack2.Data8 = ((Uint16)(((float)NO2Cur / 10 - 16.161 ) / 0.9599 ) >> 8)  & 0xff;
}
#endif
