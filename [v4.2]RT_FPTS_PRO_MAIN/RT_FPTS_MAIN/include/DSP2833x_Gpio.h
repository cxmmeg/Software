...
//------------------I/O口输入消抖延时-----------------------------
//
#define ERROR_GPIOIN	50

//------------------输出端口宏定义--------------------------------
//
#define GPIO_OUT1			1		// GPIO输出口宏定义，一般不用更改
#define GPIO_OUT2			2
#define GPIO_OUT3			3
#define GPIO_OUT4			4
#define GPIO_LED1			5		// 软启动模式指示灯
#define GPIO_LED2			6		// 第二路电源为主电指示灯
#define GPIO_LED3			7		// STANDBY LED
#define GPIO_LED4			8		// RUN LED
#define GPIO_LED5			9		// FAULT LED
#define GPIO_LED6			10		// ALARM LED
#define SCI_CONB			11
#define SCI_CONC			12
#define D00					13		// 主DSP向备用DSP发送频率信号
#define D01					14		// 主DSP接收备用DSP的频率信号
#define D02					15		// NO1路电源在运行
#define D03					16		// NO2路电源在运行
#define IO_RESET			17		// PDP复位引脚

#define SCI_CON_SEND		1
#define SCI_CON_RECV		0
...
//#define NO1_CHANNEL  		1
//#define NO2_CHANNEL  		2
//#define ALL_CHANNEL  		3
//#define NO1_ABCHANNEL		4
//#define NO1_CCHANNEL		5
//#define NO2_ABCHANNEL		6
//#define NO2_CCHANNEL		7
//#define NO1_BCCHANNEL       8
//#define NO1_ACCHANNEL       9
//#define NO2_BCCHANNEL       10
//#define NO2_ACCHANNEL       11
//#define NO1_ACHANNEL        12
//#define NO1_BCHANNEL        13
//#define NO2_ACHANNEL        14
//#define NO2_BCHANNEL        15
...
//------------------------------------------------------------
struct  FLAG_GPIOIN_BITS {  // 位定义  0为正常    1为异常
    Uint16 GpioIn1      : 1;    // 0    1 为有输入
    Uint16 GpioIn2      : 1;    // 1    1 为有输入
    Uint16 GpioIn3      : 1;    // 2    1 为有输入
    Uint16 GpioIn4      : 1;    // 3    1 为有输入
    Uint16 GpioIn5      : 1;    // 4    1 为有输入
    Uint16 GpioIn6      : 1;    // 5    1 为有输入
    Uint16 GpioIn7      : 1;    // 6    1 为有输入
    Uint16 GpioIn8      : 1;    // 7    1 为有输入
...
void 	GpioRead(void);
void 	CtrlSCREnable(Uint16 channel);
