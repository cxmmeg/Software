...
PAGE 1 :   /* Data Memory */
   	...
   	EXRAM_REG	: origin = 0x180000, length = 0x004000		/* 扩展外部RAM_16K*/
	EXRAM	   	: origin = 0x184000, length = 0x014000		/* 扩展外部RAM_80K*/
	EMRAM	   	: origin = 0x1A0000, length = 0x020000		/* 应急数据RAM_128K*/
...
SECTIONS
{
	...
	.PowerRmsReg		: > RAML7		PAGE = 1
	.VVVFReg			: > RAML7		PAGE = 1
	.SVPWMData			: > RAML7		PAGE = 1
