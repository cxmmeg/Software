...
#endif
/******************   用户修改区  ***********************/
#define STANDBY_LED		GPIO_OUT1
#define RUN_LED			GPIO_OUT2
#define FAULT_LED		GPIO_OUT3
#define MAIN_CIRCUIT_KM	GPIO_OUT5
#define PRE_CHARGE_KM	GPIO_OUT6
#define FAN_KM			GPIO_OUT7
#define DISCHARGE_KM	GPIO_OUT8
...
#define SCI_CON_SEND		0
#define SCI_CON_RECV		1
