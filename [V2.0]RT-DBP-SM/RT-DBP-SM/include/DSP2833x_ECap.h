...
//==========================
// CAPxPOL bits
#define EC_RISING		0x00		// 上升沿抓捕
#define EC_FALLING		0x01		// 下降沿抓捕
// CTRRSTx bits
#define EC_ABS_MODE		0x00		// 抓捕后不复位计数器（绝对时间运行）
#define EC_DELTA_MODE	0x01		// 抓捕后复位计数器（差分时间运行）
// PRESCALE bits
#define EC_BYPASS 		0x0			// 事件滤除预定标选择
#define EC_DIV1 		0x0			// 除以 1
#define EC_DIV2 		0x1			// 除以 1
#define EC_DIV4 		0x2			// 除以 2
#define EC_DIV6 		0x3			// 除以 3
#define EC_DIV8 		0x4			// 除以 4
#define EC_DIV10 		0x5			// 除以 10

// ECCTL2 ( ECAP Control Reg 2)
//==========================
// CONT/ONESHOT bit
#define EC_CONTINUOUS 	0x0			// 捕捉模式运行于连续模式
#define EC_ONESHOT 		0x1			// 捕捉模式运行于单次模式
// STOPVALUE bit
...
#define EC_ARM 0x1
// TSCTRSTOP bit
#define EC_FREEZE 		0x00		// 时间标签计数器停止--捕捉停止
#define EC_RUN 			0x01		// 时间标签计数器运行--捕捉使能
// SYNCO_SEL bit
#define EC_SYNCIN 		0x00		// 选择内部同步信号为外部同步信号
#define EC_CTR_PRD 		0x01		// 选择CTR=PRD时间作为外部同步信号
#define EC_SYNCO_DIS 	0x02		// 禁止外部同步信号
// CAP/APWM mode bit
#define EC_CAP_MODE 	0x00		// CAP1~CAP4工作在CAP模式下
#define EC_APWM_MODE 	0x01		// CAP1~CAP4工作在APWM模式下
// CYNCI_EN bit
#define EC_SYNCI_DIS	0X00		// 禁止内部同步选择
#define EC_SYNCI_EN		0x01		// 使能CYNCI信号强制事件使CTRPHS寄存器装载计数器
// APWMPOL bit
#define EC_ACTV_HI 0x0
#define EC_ACTV_LO 0x1
// Generic
#define EC_DISABLE 		0x0			// 捕捉时间禁止
#define EC_ENABLE 		0x1			// 捕捉事件使能
#define EC_FORCE 		0x1
