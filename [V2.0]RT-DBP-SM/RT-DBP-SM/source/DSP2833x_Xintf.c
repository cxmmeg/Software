...
void InitXintf(void)
{
    ...
    XintfRegs.XTIMING6.bit.X2TIMING = 1;		// 1
...
void InitXintf16Gpio(void)
{
     ...
     GpioCtrlRegs.GPBMUX1.bit.GPIO37 = 0;  // XZCS7
     GpioCtrlRegs.GPAMUX2.bit.GPIO28 = 3;  // XZCS6

//     GpioDataRegs.GPADAT.bit.GPIO28	 = 0;   //Setup the output DATA=1; Then default output of the connenction is low;
//     GpioCtrlRegs.GPAMUX2.bit.GPIO28 = 0;   //setup the 	function is GPIO;
//     GpioCtrlRegs.GPADIR.bit.GPIO28  = 1;   //Setup the direction is outport;
